...
- Run time UTC: `2026-05-13T06:28:22+00:00`
- Commit SHA: `91d1a0400a11e342af3e51c6a60b0b21da968e20`
- Mode: `full`
...
- **FAIL** `ioc-package-format` `data/iocs.json` `160`: invalid package IOC: Windsurf 1.9544.26 and prior
- **FAIL** `ioc-package-format` `data/iocs.json` `161`: invalid package IOC: 9 out of 11 public MCP registries successfully poisoned in PoC
...
- **REVIEW** `evidence-url-review` `posts/2026-05-13-litellm-cve-2026-42208-sql-injection-active-exploitation.md` `2026-05-13-litellm-cve-2026-42208-sql-injection-active-exploitation`: 1 source URL(s) require review
...
```text
Report: 2026-05-13-litellm-cve-2026-42208-sql-injection-active-exploitation
