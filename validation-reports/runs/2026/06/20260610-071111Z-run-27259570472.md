...
- Run time UTC: `2026-06-10T07:11:11+00:00`
- Commit SHA: `1226a901dd9d461d68c3d5a323c5da5fe2a59391`
- Mode: `full`
...
- Reports checked: `17`
- Reports skipped: `126`
- Reports newly validated: `16`
- IOC duplicates found: `0`
- Source URLs checked: `38`
...
- **REVIEW** `evidence-url-review` `posts/2026-06-02-llmshare-chatgpt-claude-malware-campaign.md` `2026-06-02-llmshare-chatgpt-claude-malware-campaign`: 1 source URL(s) require review
...
- **REVIEW** `evidence-url-review` `posts/2026-04-29-litellm-cve-2026-42208-sql-injection.md` `2026-04-29-litellm-cve-2026-42208-sql-injection`: 1 source URL(s) require review
...
```text
Report: 2026-06-02-llmshare-chatgpt-claude-malware-campaign
Problem: evidence-url-review
Validator finding: 1 source URL(s) require review
Recommended options:
[ ] Keep report and add/confirm valid source
...
```text
Report: 2026-04-29-litellm-cve-2026-42208-sql-injection
Problem: evidence-url-review
Validator finding: 1 source URL(s) require review
Recommended options:
[ ] Keep report and add/confirm valid source
